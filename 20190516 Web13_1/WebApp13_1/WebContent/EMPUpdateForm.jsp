...
<%
	...
	// search 메소드 호출 empdaono
	
	// 옵션값 출력 empdao, deptdao
	...
	<form action="EMPUpdate.jsp?empno="<%=empno %> method="post" id="empForm">
		<table class="table">
			...
			<tr>
				...
				<td>
					<select id="dname" name="dname" style="width:100%;">
						<option value="" selected="selected" value="<%=dname %>">부서 선택</option>
			...
			<tr>
				...
				<td>
					<select name="mname" id="mname" style="width:100%;">
						<option value="" selected="selected" value="<%=mname %>">매니저선택</option>
			...
			<tr>	
				<th>급여</th>
				<td>
					<input type="text" id="sal" name="sal" value="<%= sal %>">
				</td>
				<td>
			...
			<tr>
				<th>수당</th>
				<td>
					<input type="text" id="comm" name="comm" value="<%= comm %>">
				</td>
				<td>
